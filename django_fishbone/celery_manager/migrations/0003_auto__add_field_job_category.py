...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'celery_manager_job', 'category',
                      self.gf('django.db.models.fields.CharField')(default=u'MISC', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.category'
        db.delete_column(u'celery_manager_job', 'category')
