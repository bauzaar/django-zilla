...
class TimedatedModel(Model):
    timestamp_created = DateTimeField(
        default=get_utc_now, auto_now_add=True, db_index=True, editable=False)
    timestamp_modified = DateTimeField(
        default=get_utc_now, auto_now=True, db_index=True, editable=False)
